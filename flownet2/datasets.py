...
class StaticCenterCrop(object):
    ...
    def __call__(self, img):
        return img[
            (self.h - self.th) // 2 : (self.h + self.th) // 2, (self.w - self.tw) // 2 : (self.w + self.tw) // 2, :
        ]
...
class MpiSintelClean(MpiSintel):
    def __init__(self, args, is_cropped=False, root="", replicates=1):
        super(MpiSintelClean, self).__init__(
            args, is_cropped=is_cropped, root=root, dstype="clean", replicates=replicates
        )
...
class MpiSintelFinal(MpiSintel):
    def __init__(self, args, is_cropped=False, root="", replicates=1):
        super(MpiSintelFinal, self).__init__(
            args, is_cropped=is_cropped, root=root, dstype="final", replicates=replicates
        )
...
class FlyingThingsClean(FlyingThings):
    def __init__(self, args, is_cropped=False, root="", replicates=1):
        super(FlyingThingsClean, self).__init__(
            args, is_cropped=is_cropped, root=root, dstype="frames_cleanpass", replicates=replicates
        )
...
class FlyingThingsFinal(FlyingThings):
    def __init__(self, args, is_cropped=False, root="", replicates=1):
        super(FlyingThingsFinal, self).__init__(
            args, is_cropped=is_cropped, root=root, dstype="frames_finalpass", replicates=replicates
        )
...
class ChairsSDHomTrain(ChairsSDHom):
    def __init__(self, args, is_cropped=False, root="", replicates=1):
        super(ChairsSDHomTrain, self).__init__(
            args, is_cropped=is_cropped, root=root, dstype="train", replicates=replicates
        )
